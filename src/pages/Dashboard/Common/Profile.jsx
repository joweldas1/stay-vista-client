...
import UpdateUserModal from '../../../components/Shared/Modal/UpdateUserModal'
import ResetUserPassword from '../../../components/Shared/Modal/ResetUserPassword'
          ...
          <div className='w-full p-2 mt-4 rounded-lg'>
            <div className='flex flex-wrap items-center justify-between text-sm text-gray-600 '>
              ...
              <div>
                ...
                <UpdateUserModal
                isOpen={isModalOpen}  setIsOpen={setModalOpen} user={user} updateUserProfile ={updateUserProfile}
                />
                <button
